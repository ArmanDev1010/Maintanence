    ...
    <div className="relative w-full min-h-screen text-white">
      <div className="absolute top-[15%] left-1/2 translate-x-[-50%] z-[2] pointer-events-none max-[650px]:w-[60%] max-[500px]:w-[80%]">
        <img
          src={Logo}
          alt="logo"
          className="mx-auto w-[450px] mb-20 max-[1280px]:mb-12 max-[650px]:w-auto"
        />
      ...
      <div className="absolute w-full h-full z-[1] bg-black/60 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[15px]"></div>
    </div>
  );
}
